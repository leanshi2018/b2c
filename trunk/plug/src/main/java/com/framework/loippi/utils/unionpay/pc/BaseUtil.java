package com.framework.loippi.utils.unionpay.pc;
...
public class BaseUtil {
    ...
    public static String backUrl = "http://localhost:8080/ACPTest/acp_back_url";// 受理方和发卡方自选填写的域[O]--后台通知地址
    ...
    /**
     * java main方法 数据提交 　　 对数据进行签名 加载指定的证书
     *
     * @param contentData
     * @return　签名后的map对象
     */
    @SuppressWarnings("unchecked")
    public static Map<String, String> signData(Map<String, ?> contentData, InputStream certPath, String certPwd) {
