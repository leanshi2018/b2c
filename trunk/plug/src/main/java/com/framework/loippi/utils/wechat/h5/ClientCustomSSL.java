 ...
 *
 */
package com.framework.loippi.utils.wechat.h5;
...
public class ClientCustomSSL {
    ...
    public String doRefund(String url, String data) throws Exception {
        ...
        // FileInputStream instream = new FileInputStream(new File(WachatContent.signCertpath));//P12文件目录
        InputStream instream = this.getClass().getClassLoader().getResourceAsStream("wechat/h5_apiclient_cert.p12");//P12文件目录
        try {
            /**
             * 此处要改
             * */
