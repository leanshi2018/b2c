...
public interface AllInPayConstant {
     ...
     * 分账回调地址
     */
    //public static final String CUT_BILL_BACKURL="http://cnczhg.natappfree.cc/admin_war_exploded/admin/allinpayContract/cutBack.jhtml";
     ...
     * 通联网络签约后台回调地址
     */
    //public static final String SIGN_BACK_URL="http://cnczhg.natappfree.cc/admin_war_exploded/admin/allinpayContract/signBack.jhtml";
