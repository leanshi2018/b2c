    ...
    <div class="page">
        <div class="fixed-bar">
            <div class="item-title">
                <ul class="tab-base">
                    <li>
                        <a href="${base}/admin/jpush/list.jhtml"><span>管理</span></a>
                    </li>
...
<#--                            否-->
                    ...
                    <tr class="noborder">
                        ...
                        <td>
                            <input name="" id="" type="text" value="" class="w200"/>
                            <span class="error-message"></span>
                        </td>
                    </tr>
                    <tr class="noborder">
                    ...
                    <tr class="noborder">
                        ...
                        <td>
                            <select name="jumpPath" class="w150" id="jumpPath">
                                ...
                                <option value="homepage" <#if jpush.jumpPath == 'homepage'>selected="selected"</#if>>跳转商品推荐页</option>
                                <option value="messagepage"<#if jpush.jumpPath == "messagepage">selected="selected" </#if>>跳转路径</option>
                                <option value="goodsdetailspage" id="goodsdetailspage" <#if jpush.jumpPath == "goodsdetailspage">selected="selected" </#if>>跳转链接</option>
                            </select>
                            <span class="error-message"></span>
                        </td>
                    </tr>
                        ...
                        <td>
                            <div class="col-sm-9">
                                <div class="col-lg-1" STYLE="width: 90%;">
                                    <#--选择跳转商品推荐页-->
                                    <select name="" class="w150" id="">
                                        <option value="" selected="selected">请选择</option>
                                    </select>
                                    <#--选择跳转链接-->
                                    <input name="" id="" type="text" value="" class="w150"/>
                                    <#--选择跳转路径-->
                                    <select name="jumpPath" class="w150" id="jumpPath">
                                        <option value="" selected="selected">请选择</option>
                                    ...
                                    <input type="text" class="text w500" value="${article.id}" name="id" >
                                    <#--选择活动-->
    ...
    <script>
        ...
        function activityGoodsListpage() {
            ...
            layer.open({
                ...
                shade: [0.3, '#393D49'],//开启遮罩层
                title: '选择活动',
                content: ['${base}/admin/jpush/findActivitys.jhtml?info=' + activityId, 'yes'],
                area: ['800px', '600px']
            })
        }
        function appendWareInfo(id, name) {
